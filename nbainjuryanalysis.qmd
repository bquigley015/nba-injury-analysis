...
logitModel <- glm(injuryOccurred ~ player_name + team_abbreviation + age + player_height + player_weight + season_start, 
                   data = statsInjruies, 
                   family = binomial)
...
head(playerSummary[order(-playerSummary$predicted_risk), ], 100)
